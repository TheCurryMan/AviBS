...
public class GameController
{
    ...
    /**
     * Constructs a new GameController with an ArrayList of the players who will
     * be participating in the game. Initializes currentPile to an empty pile.
     * 
     * @param players
     *            the list of players who will be playing in the game
     * @author Avi
     */
     ...
     * printed out. If it's a human player, the player's current hand is first
     * printed out. The player is then prompted for an input, and they can play
     * either B for bluff, P for play, or S for skip. If they play B for bluff,
     * then the program checks to see if they are correct/if the previous player
     * who played a card actually played what they said they did. If so, the
     * player who called the bluff gets all the cards. If not, the player who
     * played the wrong card gets the pile. If the player enters S for skip, the
     * next player in the rotation will be prompted to play. If a player enters
     * P for play, then they will be prompted for the number of cards they want
     * to play and the actual cards in their hand that they are going to play.
     * The program also clears the pile if everyone skips, and if someone
     * plays/calls a bluff after another player empties their hand, then the
    ...
    public void nextTurn( Player p )
    {
        ...
        else
        {
            ...
            System.out.println( "There are currently "
                + currentPile.getNumOfCards() + " cards in the pile" );
            if ( currentPile.hasCurrentCard() )
            {
                System.out.println(
